...
scoreboard players set #check_uuid2 ifl.dummy 0
...
execute if score #check_uuid ifl.dummy matches 4.. store result score #check_uuid2 ifl.dummy run data get storage ifl:storage attribute_modifier.UUID[0]
execute unless score #check_uuid2 ifl.dummy matches 0 run scoreboard players add #check_uuid ifl.dummy 1
execute if score #check_uuid ifl.dummy matches 4.. store result score #check_uuid2 ifl.dummy run data get storage ifl:storage attribute_modifier.UUID[1]
execute unless score #check_uuid2 ifl.dummy matches 0 run scoreboard players add #check_uuid ifl.dummy 1
execute if score #check_uuid ifl.dummy matches 4.. store result score #check_uuid2 ifl.dummy run data get storage ifl:storage attribute_modifier.UUID[2]
execute unless score #check_uuid2 ifl.dummy matches 0 run scoreboard players add #check_uuid ifl.dummy 1
execute if score #check_uuid ifl.dummy matches 4.. store result score #check_uuid2 ifl.dummy run data get storage ifl:storage attribute_modifier.UUID[3]
execute unless score #check_uuid2 ifl.dummy matches 0 run scoreboard players add #check_uuid ifl.dummy 1
...
execute if score #attribute_operation ifl.dummy matches 0..2 if score #check_uuid ifl.dummy matches 7.. if data storage ifl:storage attribute_modifier.Slot if data storage ifl:storage attribute_modifier.AttributeName run function itemflexer:display/get_lore/add
...
execute if data storage ifl:storage attribute_modifier.Slot if score #attribute_operation ifl.dummy matches 0..2 if data storage ifl:storage attribute_name if score #check_uuid ifl.dummy matches 7.. unless score #attribute_amount ifl.dummy matches 0 run function itemflexer:display/get_lore/attributes/add
execute unless data storage ifl:storage attribute_modifier.Slot if score #attribute_operation ifl.dummy matches 0..2 if data storage ifl:storage attribute_name if score #check_uuid ifl.dummy matches 7.. unless score #attribute_amount ifl.dummy matches 0 run function itemflexer:display/get_lore/attributes/all_slots
