...
execute if data storage ifl:storage attribute_modifier.Slot if data storage ifl:storage attribute_modifier.AttributeName run function itemflexer:display/get_lore/add
...
execute if data storage ifl:storage attribute_modifier.Slot if data storage ifl:storage attribute_name unless score #attribute_amount ifl.dummy matches 0 run function itemflexer:display/get_lore/attributes/add
execute unless data storage ifl:storage attribute_modifier.Slot if data storage ifl:storage attribute_name unless score #attribute_amount ifl.dummy matches 0 run function itemflexer:display/get_lore/attributes/all_slots
